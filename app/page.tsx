...
import collectifComamand from "../src/command.png";
  ...
  return (
    <>
      ...
      <main className="relative justify-center items-center flex py-24 mx-auto my-8 w-[calc(100vw-64px)] h-[calc(100vh-64px)] backdrop-blur-sm [--webkit-backdrop-filter:blur(4px)] bg-gray-600/5 rounded-2xl border-[#2e2e2e] border-2">
        ...
        <div className="flex flex-col m-auto bg-gray-800/10 backdrop-blur-sm [--webkit-backdrop-filter:blur(4px)] border-[#2e2e2e] border-2 rounded-2xl w-[90vw] max-h-full overflow-hidden isolate">
          <div className="flex flex-col items-center p-20 gap-5 w-full overflow-y-auto overflow-x-hidden">
            <div className="shrink-0 bg-gray-500/70 rounded-full w-40 h-40 overflow-hidden border-[#2e2e2e] border-2 hover:border-[#7e7e7e] transition">
              <Image
                src={pfp}
                width={2560}
                height={1440}
            ...
            <div className="shrink-0 font-medium text-md bg-gray-900/70 pl-10 pr-10 pt-5 pb-5 rounded-xl text-[#0FBF3E] w-[calc(100vw-30vw)] lg:w-[calc(100vw-70vw)] md:w-[calc(100vw-60vw)] sm:w-[calc(100vw-60vw)] border-[#2e2e2e] border-2 hover:border-[#7e7e7e] transition">
              <h1 className="text-xl underline mb-3 text-blue-300">
                # Who am I?
              </h1>
              <h2>
                &gt; Hi There! I'm Adeebur, aka domos000, a student from India
                who likes technology! <br /> &gt; I know HTML, CSS, Python,
                Next.JS and TailwindCSS. <br /> &gt; I'm currently learning C
                and I like Arch btw :3
              </h2>
            </div>
            <div className="shrink-0 font-medium text-md bg-gray-900/70 pl-10 pr-10 pt-5 pb-5 rounded-xl text-[#0FBF3E] w-[calc(100vw-30vw)] lg:w-[calc(100vw-70vw)] md:w-[calc(100vw-60vw)] sm:w-[calc(100vw-60vw)] border-[#2e2e2e] border-2 hover:border-[#7e7e7e] transition">
              <h1 className="text-xl underline mb-3 text-blue-300">
            ...
            <div className="shrink-0 font-medium text-md bg-gray-900/70 pl-10 pr-10 pt-5 pb-5 rounded-xl text-[#0FBF3E] w-[calc(100vw-30vw)] lg:w-[calc(100vw-70vw)] md:w-[calc(100vw-60vw)] sm:w-[calc(100vw-60vw)] border-[#2e2e2e] border-2 hover:border-[#7e7e7e] transition">
              ...
              <h2>
                &gt; <b>Web Dev:</b> HTML, CSS, Next.JS, TailwindCSS <br /> &gt;{" "}
                <b>Programming:</b> Python, C (both learning) <br /> &gt;{" "}
                <b>Other:</b> Git, GitHub, Linux, VS Code <br />
              </h2>
            </div>
            <h1 className="shrink-0 font-semibold text-3xl text-blue-300 underline p-2 rounded-xl cursor-default">
              # My Projects:
            </h1>
            <div className="shrink-0 flex flex-col bg-gray-900/70 rounded-xl border-[#2e2e2e] border-2 w-[calc(100vw-20vw)] lg:w-[calc(100vw-20vw)] md:w-[calc(100vw-30vw)] sm:w-[calc(100vw-40vw)] overflow-hidden isolate">
              <div className="flex flex-row p-5 gap-5 w-full overflow-x-auto">
                <div className="relative shrink-0 bg-gray-900 w-[60vw] sm:w-[60vw] md:w-[50vw] lg:w-[30vw] h-[30vh] rounded-3xl border-[#3e3e3e] p-5 border-2 overflow-hidden hover:border-[#7e7e7e] transition">
                  <Image
                    src={klair}
                    width={1920}
                    height={1080}
